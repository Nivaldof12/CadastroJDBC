...
import br.com.nivaldo.dao.ProdutoDaoMock;
...
import br.com.nivaldo.services.IProdutoService;
import br.com.nivaldo.services.ProdutoService;
...
public class ProdutoServiceTest {
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException {
		produto.setNome("Nivaldo F");
		produtoService.alterar(produto);
		
		Assert.assertEquals("Nivaldo F", produto.getNome());
	}
}
